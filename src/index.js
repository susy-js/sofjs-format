...
function formatQuantity(value, encode, pad) {
  ...
  if (numberToBN(value).isNeg()) { throw new Error(`[sofjs-format] while formatting quantity '${numberValue.toString(10)}', invalid negative number. Number must be positive or zero.`); }
